...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2025 at 10:32 AM
...
SET MESSAGE_TEXT = 'stok ga cukup';
END IF;
...
SELECT 'Transaksi Sukses' AS pesan;
END$$
...
--
DELIMITER $$
CREATE TRIGGER `tambah_transaksi` AFTER UPDATE ON `transaksi` FOR EACH ROW UPDATE pelanggan
SET status_member = CASE
