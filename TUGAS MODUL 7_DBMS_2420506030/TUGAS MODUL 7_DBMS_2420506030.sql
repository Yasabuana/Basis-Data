...
ALTER TABLE `produk`
  ...
  ADD UNIQUE KEY `unq_idx` (`kode_produk`),
...
--
ALTER TABLE `transaksi`
  ADD CONSTRAINT `fk` FOREIGN KEY (`id_pelanggan`) REFERENCES `pelanggan` (`id_pelanggan`),
